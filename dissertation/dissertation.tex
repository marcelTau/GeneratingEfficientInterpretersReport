...
%TODO rewrite this, not saying compilers try to optimize
...
%You have a big downside to discuss in your approach, in that you saw a big
%slowdown when you tried to add threaded code. You can write about how the
%choice to use Rust, and the particular Rust types/features you used, brought
%that about. Like, that you used enums and discriminants a hash table, whereas a
%lower level VM implementation would represent the bytecode as a byte array and
%the computed GOTO table as a plain array of pointers.
...
%TODO this is now in approaches
